...
public class Operator {
	...
	public static void main(String[] args) {
		...
		booleanResult = (a < b) && (++a > 0); // 논리 and 연산자 좌항에 false가 와서 우항을 읽어들이지 않음
		System.out.println(a); 
		
		booleanResult = (a > b) || (++a > 0); // 위와 마찬가지
		System.out.println(a);
		
		// 삼항 연산자 : 조건에 따라 지정한 결과를 반환하는 연산자
		// 조건(논리식) ? 참일떄 결과 : 거짓일떄 결과
		int age = 10;
		
		
		String stringResult = age > 19 ? "성인" : "미성년자"; // 데이터 타입에 맞는걸 결과값에 넣어야함
