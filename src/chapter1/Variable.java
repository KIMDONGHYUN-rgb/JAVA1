...
public class Variable {
	...
	public static void main(String[] args) {
		...
		// 1. 띄워쓰기 규칙
		// web site address
		// - Camel Case : 띄워쓰기를 표현할 떄 띄워쓰기를 제거하고 바로 뒤 문자를 대문자로 표현 
		...
		// 변수 선언 시에 데이터 타입 앞에 final 키워드를 붙혀서 선언
		// final 데이터타입 변수명(상수명);
		final int MAX;
		MAX = 100;
		...
		final double IPHONE_15PRO_HEIGHT = 146.6;
		final double IPHONE_15PRO_WIDTH = 70.6;
		
		double size2 = IPHONE_15PRO_HEIGHT * IPHONE_15PRO_WIDTH;
