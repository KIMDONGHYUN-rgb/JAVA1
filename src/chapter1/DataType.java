...
public class DataType {
	...
	public static void main(String[] args) {
		...
		int int1 = 32768;
		int1 = 2_147_483_647; // 가시성을 위해 언더바 사용가능
		// int1 = 2_147_483_648L;
		// 정수형 리터럴 상수는 int 타입임
		...
		// 메모리 공간을 절약할떄 사용되는 정수형 타입 : byte, short
		// 큰 수를 다룰 떄 사용되는 정수형 타입 : long
		...
		// 논리형 데이터 타입 : 참과 거짓의 값을 가지는 데이터 타입
		...
		char char3 = 100;
		short short2 = (short) char3; // 같은 2byte지만 사이즈가 조금 다르다 (강제 형변환 해줘야된다)
		int int2 = char3;
		...
		System.out.println(chars1); // 문자의 배열은 자주 사용한다 (문자의 배열은 직접 꺼내서 보여준다)
		...
		// lastIndexOf(문자열): 찾고자하는 문자열의 마지막 찾은 위치의 인덱스 번호를 변환
		statement = "내가 그린 기린 그림은 잘 그린 기린 그림이고 네가 그린 기린 그림은 잘 못그린 기린 그림이다";
		System.out.println(statement.indexOf("기린"));
		System.out.println(statement.indexOf("사자")); // 없는걸 찍을 경우 -1
		System.out.println(statement.lastIndexOf("기린"));
		System.out.println(statement.lastIndexOf("사자")); // 마찬가지로 -1
